...
#### Important:
all files in `./infrastructure/persistence/ent` are generated each time you run the generate. You should just edit your schema files that are in `./infrastructure/persistence/ent/schema`. So, If you changed anything in schema you do not need to modify or remove other files, just run `generate`
